...
export const RotatingBezel: FC = () => {
    ...
    const handleMouseMove = ({ currentTarget: target, clientX, clientY }: MouseEvent<HTMLDivElement>): void => {
    ...
    return (
        <RotatingBezelStyled ref={circleRef} rotation={rotation} onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} onMouseMove={handleMouseMove}>
            <InsideBorderStyled />
